...
krb2timer = 21
function romhack_hook_update()
if RH_Name ~= "None" then
STRGST.BuildInRomhacks = true
end 
...
or RH_Name == "SM64: The Underworld" or RH_Name == "Super Mario 74" or RH_Name == "SM74: Ten Years After" or RH_Name == "Super Mario The Power Star Journey") then
...
or RH_Name == "The Phantom's Call" or RH_Name == "Thousand Year Door 64") then
...
function romhack_mario_update(m)
if STRGST.STRGameState == "Started" and STRGST.STRGameMode ~= 4 then
...
or (RH_Name == "SM64: Trouble Town" and m.numStars >= 30) then
STRGST.STRGameState = "Finished"
end
...
function romhack_interact(m, o, type)
if STRGST.STRGameState == "Started" and STRGST.STRGameMode ~= 4 then 
if (RH_Name == "Only Up 64" and type == INTERACT_STAR_OR_KEY) 
...
if STRMenuDisplay == false and RH_Name ~= "None" then
	Size = 0.75
	Height = 32 * Size
	Width = 0 * Size
	X = (S_Width() - Width) / 2.0
	...
	shadow_text("120 Green Stars", X - 70, Y + 50, Size - 0.40, 0.95, 0.95, 255, 255, 255, 255)
	shadow_text("Beat The Game with All 120 Stars", X - 70, Y + 60, Size - 0.50, 0.50, 0.50, 255, 255, 255, 255)
	...
	shadow_text("120 Green Stars", X - 70, Y + 20, Size - 0.40, 0.95, 0.95, 255, 255, 255, 255)
	...
	shadow_text("All Glitches are Allowed", X - 70, Y + 7, Size - 0.50, 0.50, 0.50, 255, 255, 255, 255)
	elseif RH_Name == "Only Up 64" then
...
local function romhack_mods_loaded(m)
if RH_Name == "Lug's Delightful Dioramas" then
_G.STRApi.add_run_slot(1, "64 Stars")
_G.STRApi.add_run_slot(2, "74 Stars")
elseif RH_Name == "Sonic Adventure 64 DX" then
_G.STRApi.add_run_slot(1, "1 Star")
_G.STRApi.add_run_slot(2, "3 Stars")
elseif RH_Name == "Star Revenge 3: Mario on An Saoire 64" then
_G.STRApi.add_run_slot(1, "1 Star")
_G.STRApi.add_run_slot(2, "36 Stars")
_G.STRApi.add_run_slot(3, "65 Stars")
elseif RH_Name == "Super Bell Thrill" then
_G.STRApi.add_run_slot(1, "1 Star")
_G.STRApi.add_run_slot(2, "7 Stars")
elseif RH_Name == "SM64: Moonshine" then
_G.STRApi.add_run_slot(1, "31 Stars")
_G.STRApi.add_run_slot(2, "50 Stars")
elseif RH_Name == "Super Mario Rainbow Road" then
_G.STRApi.add_run_slot(1, "54 Stars")
_G.STRApi.add_run_slot(2, "60 Stars")
elseif RH_Name == "Star Road" or RH_Name == "Star Road: The Replica Comet" then
_G.STRApi.add_run_slot(1, "Any%")
_G.STRApi.add_run_slot(2, "20 Stars")
_G.STRApi.add_run_slot(3, "65 Stars")
_G.STRApi.add_run_slot(4, "80 Stars")
_G.STRApi.add_run_slot(5, "130 Stars")
elseif RH_Name == "Star Road: The Replica Comet" then
_G.STRApi.add_run_slot(6, "150 Stars")
elseif RH_Name == "Ztar Attack 2" then
_G.STRApi.add_run_slot(1, "Any%")
_G.STRApi.add_run_slot(2, "Warpless Any%")
_G.STRApi.add_run_slot(3, "81 Time Stars")
_G.STRApi.add_run_slot(4, "91 Time Stars")
_G.STRApi.add_run_slot(5, "All Bosses")
end
end

hook_event(HOOK_ON_MODS_LOADED, romhack_mods_loaded)
