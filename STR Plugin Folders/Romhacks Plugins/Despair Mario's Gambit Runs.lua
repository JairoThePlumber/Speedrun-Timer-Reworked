...
Despair_Mario_Gambit = false 

for romhack in pairs(gActiveMods) do
	if gActiveMods[romhack].name:find("Despair Mario's Gambit") then
        Despair_Mario_Gambit = true
    end
end

if not Despair_Mario_Gambit then return end

local function despair_mario_gambit_position(m)
if _G.SpeedrunTimerReworked then
if Despair_Mario_Gambit then 
...
_G.STRApi.set_custom_color_on_RH_Fonts("Number Colors", "Words Colors", "Single Quote No Colors", "Double Quotes No Colors")
		end
	end
end
