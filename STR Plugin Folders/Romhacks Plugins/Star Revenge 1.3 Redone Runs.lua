...
if gActiveMods[romhacks].name:find("Star Revenge 1.3") and gActiveMods[romhacks].name:find("Redone 1.3") then
...
if gActiveMods[custom_romhack_rules].name:find("Star Revenge 1.3") and gActiveMods[custom_romhack_rules].name:find("Redone 1.3") then
-- This display the borderline
_G.STRApi.Display_Custom_Rules_Romhack(190, 120, FONT_MENU, 320, 240, "#ffffff")
_G.STRApi.Display_Custom_Rules_Romhack_Function(6422, -995, 4707, true)
