...
if _G.SpeedrunTimerReworked and Romhack_Is_Enabled == false then
	...
	_G.STRApi.add_custom_run(4, "31 Stars")
	_G.STRApi.add_custom_run(5, "45 Stars")
	_G.STRApi.add_custom_run(6, "50 Stars")
	_G.STRApi.add_custom_run(7, "70 Stars")
	_G.STRApi.add_custom_run(8, "90 Stars")
	_G.STRApi.add_custom_run(9, "120 Stars")
	else
...
if Romhack_Is_Enabled == false then
	...
	_G.STRApi.custom_romhack_runs("31 Star", m.numStars >= 31 and get_id_from_behavior(o.behavior) == id_bhvGrandStar)
	_G.STRApi.custom_romhack_runs("45 Star", m.numStars >= 45 and get_id_from_behavior(o.behavior) == id_bhvGrandStar)
	_G.STRApi.custom_romhack_runs("50 Star", m.numStars >= 50 and get_id_from_behavior(o.behavior) == id_bhvGrandStar)
