...
_G.STRApi.add_run_slot(1, "0 Stars")
_G.STRApi.add_run_slot(2, "1 Star")
_G.STRApi.add_run_slot(3, "15 Stars")
_G.STRApi.add_run_slot(4, "16 Stars")
_G.STRApi.add_run_slot(5, "31 Stars")
_G.STRApi.add_run_slot(6, "45 Stars")
_G.STRApi.add_run_slot(7, "50 Stars")
_G.STRApi.add_run_slot(8, "70 Stars")
_G.STRApi.add_run_slot(9, "90 Stars")
_G.STRApi.add_run_slot(10, "120 Stars")
else
_G.STRApi.add_run_slot(1, "16 Stars")
_G.STRApi.add_run_slot(2, "70 Stars")
_G.STRApi.add_run_slot(3, "90 Stars")
_G.STRApi.add_run_slot(4, "120 Stars")
end
